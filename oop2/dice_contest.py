...
def main():
    ...
    # the player who always roll 6
    high_dice = Cheat_HighRoller()
    ...
    while game_number < number_of_games:
        ...
        if sum(high_dice.get_dice()) == sum(loaded_dice.get_dice()):
            #print("Draw!")
            pass
        elif sum(high_dice.get_dice()) > sum(loaded_dice.get_dice()):
    ...
    if high_dice_score == loaded_dice_score:
        print("Game was drawn")
    elif high_dice_score > loaded_dice_score:
